...
public class AddCourseFrame extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtCourseName, javax.swing.GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        ...
        dcEndTime.setDate(new Date(System.currentTimeMillis() + (31536000 * 1000L * 4)));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        Course course = new Course(null, txtCourseName.getText(), dcStartTime.getDate(), dcEndTime.getDate());
        if (!courseService.createNewCourse(course)) {
            JOptionPane.showConfirmDialog(null, "Thêm khóa học thất bại", "Lỗi thêm mới", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
            return;
        }

        int responseStatus = JOptionPane.showConfirmDialog(null, "Thêm khóa học thành công", "Thêm mới", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
